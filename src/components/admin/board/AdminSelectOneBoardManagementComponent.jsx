...
class AdminSelectOneBoardManagementComponent extends Component {
    constructor(props) {
        super(props);
    ...
    deleteView = async function () {
        if (window.confirm("정말로 글을 삭제하시겠습니까?\n삭제된 글은 복구 할 수 없습니다.")) {
            AdminService.deleteBoard(this.state.idx, this.state.board)
                .then(res => {
...
export default AdminSelectOneBoardManagementComponent;